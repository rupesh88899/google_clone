...
import 'package:google_clone1/services/api_service.dart';
import 'package:google_clone1/widgets/search_footer.dart';
import 'package:google_clone1/widgets/web/web_search_header.dart';
import 'package:google_clone1/widgets/search_result_component.dart';
import 'package:google_clone1/widgets/search_tabs.dart';

class SearchScreen extends StatelessWidget {
  final String searchQuery;
  final String start;
  const SearchScreen({super. key, required this.searchQuery, this.start = '0'});
